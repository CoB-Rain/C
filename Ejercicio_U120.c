/*U120. Desarrollar un programa que cargue un vector con “n” números enteros 
informados por el usuario y que muestre por pantalla: 
...
int main()
{
    ...
    int n=0;
    printf("Ingrese el tamaño de su vector: ");fflush(stdin);scanf("%i",&n);
    int vector[n];
    int i=0,min=0,max=0;
    int par=0,impar=0;
    for(i=0;i<n;i++)
